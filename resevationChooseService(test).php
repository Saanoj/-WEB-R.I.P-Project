              ...
              while($unService = $services->fetch())
              {
                ...
                if(!in_array($unService["categorie"],$categorieSet)){
                  ...
                  <li class="list-group-item row">
                    ...
                    <button class="btn btn-primary" type="button" data-toggle="collapse" data-target=".multi-collapse" aria-expanded="false" aria-controls="<?php foreach ($servicesInSameCategorie as $key => $value) { echo "categorie".$value["idService"]." "; }?>">Toggle</button>
                  </li>
                  <?php
